                ...
                firebase
                    ...
                    .then(
                        () => {
                            ...
                            that.dropDownAlertRef.alertWithType('success', t('actions.deleted'));
                            that.handleRefresh();
                        },
                        (err) => {
            ...
            <View style={{ flex:1,backgroundColor:"#fff" }}>
                ...
                <View>
                    ...
                    this.state.cards == null ? (
                        <List style={{ marginTop:5*Constants.statusBarHeight,justifyContent:"center",alignContent:"center",alignItems:"center",textAlign:"center" }}>
                        ...
                        <ScrollView>
                            <List style={{ flex:1}}>
                                <ListItem thumbnail>
                                    ...
                                    <Body>
                                        <Text style={styles.cardNumbText} children={hideNumb("151561561561515")}/>
                                        <Text children={'200  Azn'}/>
                                    </Body>
                                    <Right>
                                        <Button transparent onPress={() => this.props.navigation.navigate("Pininfo")}>
                    ...
                    <View style={{ position:"absolute",bottom:-5*Constants.statusBarHeight,left:9*Constants.statusBarHeight }}>
                        <Fab
                        ...
                        <Modal
                            ...
                            <Card style={{
                                ...
                                <CardItem header>
                                    <Left />
                                    <Body>
                                        <Text style={styles.modalTitle} children={t('cards.cartadd')}/>
                                    </Body>
                                    <Right>
                                        <TouchableOpacity
                                            onPress={() => this.setState({active: false})}>
                                            <FontAwesome style={{ fontWeight:"bold" }} name="close" size={35} color="#D50000"/>
                                        </TouchableOpacity>
                                    </Right>
                                </CardItem>
                                <CardItem>
