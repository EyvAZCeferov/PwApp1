...
export default class OneCheck extends React.Component {
    ...
    getInfo() {
        ...
        firebase
            .database()
            .ref('users/K3YfovctoSaJiS6xeQxvXKYIQMi1/checks/' + checkid)
            .on('value', (data) => {
        ...
        firebase
            .database()
            .ref('users/K3YfovctoSaJiS6xeQxvXKYIQMi1/checks/' + checkid + '/products')
            .on('value', (data) => {
            ...
            <View style={[styles.bgTransparent, styles.center]}>
                <View style={styles.headerTop}>
                    <View style={[styles.center, {
                        ...
                        <Textpopins children={t('check.tsAd') + " : "} style={{fontWeight: "700", fontSize: 16}}/>
                        <Textpopins children={this.state.check.market}
                                    style={{fontWeight: "700", fontSize: 16}}/>
                    </View>
                    <View style={{flexDirection: "row", marginVertical: 4, width: "100%", paddingHorizontal: 10}}>
                        <Textpopins
                            children={t('check.tsAddress') + " : " + this.state.check.user ? this.state.check.user : t('check.tsAddress') + " : "}/>
                    </View>
                    <View style={{marginVertical: 10}}/>
                    <View style={{flexDirection: "row", marginVertical: 4, width: "100%", paddingHorizontal: 10}}>
                        <Textpopins
                            children={t('check.voad') + " : " + this.state.check.market}/>
                    </View>
                    <View style={{flexDirection: "row", marginVertical: 4, width: "100%", paddingHorizontal: 10}}>
                        <Textpopins
                            children={t('check.voen') + " " + this.state.check.marketVoen}/>
                    </View>
                    <View style={{flexDirection: "row", marginVertical: 4, width: "100%", paddingHorizontal: 10}}>
                        <Textpopins
                            children={t('check.objectCode') + " " + this.state.check.marketCode}/>
                    </View>
                    <View style={{marginVertical: 10}}/>
                </View>
                <View style={styles.headerCenter}>
                    <View style={[styles.center, {
                        ...
                        <Textpopins children={t('check.selCheck') + " "}
                                    style={{textAlign: "left", fontWeight: "700", fontSize: 16}}/>
                        <Textpopins children={this.state.checkid}
                                    style={{textAlign: "left", fontWeight: "700", fontSize: 16}}/>
                    </View>
                </View>
                <View style={[styles.headerFooter]}>
                    <View style={{
                        ...
                        <Textpopins children={this.state.check.kassirName}
                        />
                    </View>
                    <View style={{
                        flexDirection: "row",
                        ...
                        <View style={{flexDirection: "row"}}>
                            ...
                            />
                            <Textpopins children={this.convertStampDate(this.state.check.date, 'date')}
                            />
                        </View>
                        <View style={{flexDirection: "row"}}>
                            <Textpopins children={t('check.saat') + ": "}
                            />
                            <Textpopins children={this.convertStampDate(this.state.check.date, 'hour')}
                            />
                        </View>
                    </View>
                </View>
            ...
            <View style={[styles.bgTransparent, styles.center]}>
                <View style={styles.table}>
                    <View style={styles.tableHeader}>
                        <Textpopins style={styles.tableBigArena} children={t('check.productName')}/>
                    ...
                    <View style={styles.tableFooter}>
                        <View style={styles.tableFooterElements}>
                            <Textpopins style={{maxWidth: "50%", minWidth: "10%"}}
                        ...
                        <View style={styles.tableFooterElements}>
                            ...
                            <Textpopins style={{maxWidth: "50%", minWidth: "10%"}} children="Az Smart Ficsal Box"/>
                        </View>
                        <View style={styles.tableFooterElements}>
                            <Textpopins style={{maxWidth: "50%", minWidth: "10%"}}
                        ...
                        <View style={styles.tableFooterElements}>
                            ...
                            <Textpopins style={{maxWidth: "50%", minWidth: "10%"}} children={this.state.checkid}/>
                        </View>
                        <View style={styles.tableFooterElements}>
                            <Textpopins style={{maxWidth: "50%", minWidth: "10%"}}
                                        children={t('check.nmqQeydNomresi')}/>
                            <Textpopins style={{maxWidth: "50%", minWidth: "10%"}} children={this.state.nmqCount}/>
                        </View>
                        <View style={{marginVertical: 5}}/>
                        <Seperator/>
                        <View style={{marginVertical: 10}}/>
        ...
        return (
            <View style={[styles.bgTransparent, styles.center]}>
                ...
                <View
                    ...
                    <Textpopins children="Pay And Win" style={{color: "#fff", fontWeight: "bold", fontSize: 15}}/>
                </View>
                <Textpopins children={t('check.edvTitle')} style={{fontSize: 20, fontWeight: "bold"}}/>
                <Seperator/>
        ...
        if (this.state.edvStat == "not") {
            return (
                <View style={{
                    ...
                    <Textpopins style={{fontSize: 18, fontWeight: "bold", paddingLeft: 10}}
            ...
            return (
                <View style={{
                    ...
                    <Textpopins style={{fontSize: 18, fontWeight: "bold", paddingLeft: 5}}
                    ...
                    <Header style={[styles.bgTransparent, styles.header]}>
                        ...
                        <Left style={styles.bgTransparent}>
                            ...
                            <TouchableOpacity style={[styles.bgTransparent, {paddingLeft: 10}]}
                                ...
                                <Ionicons name="arrow-back" size={24} color="#7c9d32" />
                            </TouchableOpacity>
                        </Left>
